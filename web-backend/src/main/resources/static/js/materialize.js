...
// TODO:#review: naming, documentation
                ...
                const __WEBPACK_DEFAULT_EXPORT__ = (anime);
            ...
            /***/ ((__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class Carousel extends component_1.Component {
                    constructor(el, options) {
                        ...
                        this.center = 0;
                        this._handleThrottledResize = utils_1.Utils.throttle(function () {
                            this._handleResize();
                        }, 200, null).bind(this);
            ...
            /***/ ((__unused_webpack_module, exports, __webpack_require__) => {
                ...
                class Datepicker extends component_1.Component {
                    ...
                    render(year, month, randId) {
                        let opts = this.options, now = new Date(), days = Datepicker._getDaysInMonth(year, month),
                        ...
                        let previousMonth = month === 0 ? 11 : month - 1, nextMonth = month === 11 ? 0 : month + 1,
                        ...
                        for (let i = 0, r = 0; i < cells; i++) {
                            let day = new Date(year, month, 1 + (i - before)),
                                isSelected = Datepicker._isDate(this.date)
                                    ...
                                    : false, isToday = Datepicker._compareDates(day, now),
                    ...
                    renderTitle(instance, c, year, month, refYear, randId) {
                        let i, j, arr, opts = this.options, isMinYear = year === opts.minYear,
                            isMaxYear = year === opts.maxYear, html = '<div id="' +
                                randId +
                                '" class="datepicker-controls" role="heading" aria-live="assertive">', monthHtml, yearHtml,
                            prev = true, next = true;
                        for (arr = [], i = 0; i < 12; i++) {
                    ...
                    draw(force = false) {
                        if (!this.isOpen && !force)
                            return;
                        let opts = this.options, minYear = opts.minYear, maxYear = opts.maxYear,
                            minMonth = opts.minMonth, maxMonth = opts.maxMonth, html = '', randId;
                        if (this._y <= minYear) {
                            this._y = minYear;
                    ...
                    constructor(el, options) {
                        ...
                        this._handleWindowScroll = () => {
                            ...
                            let top = utils_1.Utils.getDocumentScrollTop(),
                                left = utils_1.Utils.getDocumentScrollLeft(), right = left + window.innerWidth,
                ...
                class Timepicker extends component_1.Component {
                    constructor(el, options) {
                        ...
                        this.showView = (view, delay = null) => {
                            ...
                            let isHours = view === 'hours', nextView = isHours ? this.hoursView : this.minutesView,
                    ...
                    resetClock(delay) {
                        var _a;
                        let view = this.currentView, value = this[view], isHours = view === 'hours',
                    ...
                    setHand(x, y, roundBy5 = false) {
                        let radian = Math.atan2(x, -y), isHours = this.currentView === 'hours',
                ...
                class Tooltip extends component_1.Component {
                    ...
                    _positionTooltip() {
                        ...
                        const origin = this.el, originHeight = origin.offsetHeight, originWidth = origin.offsetWidth,
                            tooltipHeight = tooltip.offsetHeight, tooltipWidth = tooltip.offsetWidth,
