...
class CharSequencesTest {
    ...
    static class Strings2Test {
        ...
        void testCollectionToDelimitedString() {
            ...
            // Act
            String actualCollectionToDelimitedStringResult = Strings2.collectionToDelimitedString(coll,
                delim);
        ...
        void testChangeZenkakuToHankaku() {
            ...
            // Act
            String actualChangeZenkakuToHankakuResult = Strings2.changeZenkakuToHankaku(targetString);
